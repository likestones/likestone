...
Xlch88;
	...
	$sqls = [
		...
		'xlch_image'=>"INSERT INTO `xlch_image` (`ID`, `DirId`, `Url`, `Name`, `UploadId`, `AddDate`) VALUES ('1', '1', '#', '绚丽彩虹', '1', now())"
	];
				...
				<aside id="sidebar" class="sidebar c-overflow">
					<div class="s-profile">
						...
						<ul class="main-menu">
							...
							<li>
								<a target="_blank" href="#"><i class="fa fa-user"></i> 绚丽博客</a>
							</li>
							<li>
								<a target="_blank" href="#"><i class="fa fa-user"></i> 站长交流群</a>
							</li>
							<li>
								<a target="_blank" href="#"><i class="fa fa-user"></i> 同学录交流群</a>
							</li>
						</ul>
					</div>
					<ul class="main-menu">
							...
							<?php switch($Step){
								...
								<div class="card">
									...
									<div class="card-body card-padding">
										...
										<a id="stepBuuton" href="?step=<?=($Step+1)?>" class="btn btn-block bgm-white">开始安装</a>
									</div>
								</div>
								<?php break; ?>
								<?php case 4: 
...
Xlch88;
								...
								<div class="card">
									...
									<div class="card-body card-padding">
										...
										<hr></hr>
										<p><a class="c-purple" target="_blank" href="#">绚丽彩虹同学录用户群</a> | <a target="_blank" href="#">绚丽彩虹工作室</a> | <a target="_blank" href="#">绚丽彩虹商城</a> | <a target="_blank" href="#">绚丽彩虹Project</a></p>
									</div>
								</div>
								<?php break; ?>
								<?php case -1: ?>
			...
			<footer id="footer">
				...
				<ul class="f-menu">	
					<li><a target="_blank" href="#">绚丽彩虹工作室</a></li>
					<li><a target="_blank" href="#">绚丽博客</a></li>	
					<li><a target="_blank" href="#">华梦博客</a></li>
				</ul>
			</footer>
		</section>
